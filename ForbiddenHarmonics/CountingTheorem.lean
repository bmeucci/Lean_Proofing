...
theorem g4_formula_T : forbT.card = 12 / 4 := forbT_quarter_order

/-- **Theorem 3**: |Forb(O)| = |O|/4. -/
theorem g4_formula_O : forbO.card = 24 / 4 := forbO_quarter_order

/-- **Theorem 3**: |Forb(I)| = |I|/4. -/
theorem g4_formula_I : forbI.card = 60 / 4 := forbI_quarter_order
...
theorem tetrahedral_gaps_eq_forb :
    gaps_3_4 = forbT := by rw [forbT_eq_explicit]; decide
